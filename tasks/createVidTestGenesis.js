...
var network_name = "vidtest";
if(!networks[network_name]){
  console.log("WARNING: no configuration found in networks.json for '"+network_name+"'. Defaulting to 'vidtest'");
  network_name = "vidtest";
}

// directory to export passphrases of premine account and genesis delegates. Should exist
var private_dir = './vidtest';

// directory to export config and genesisBlock files. Should exist
var output_dir = './vidtest';

// default port for node
var default_port = 1886;
...
// default db named
var db_name = "vidtest_" + network_name;
...
var totalpremine = 28500000000000000;
