...
var network_name = "dantest";
if(!networks[network_name]){
  console.log("WARNING: no configuration found in networks.json for '"+network_name+"'. Defaulting to 'dannet'");
  network_name = "dantest";
}

// directory to export passphrases of premine account and genesis delegates. Should exist
var private_dir = './dantest';

// directory to export config and genesisBlock files. Should exist
var output_dir = './dantest';
...
// default db named
var db_name = "dantest_" + network_name;
...
var totalpremine = 500000000000000000;
