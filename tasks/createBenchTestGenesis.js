...
var network_name = "benchtest";
if(!networks[network_name]){
  console.log("WARNING: no configuration found in networks.json for '"+network_name+"'. Defaulting to 'benchtest'");
  network_name = "benchtest";
}

// directory to export passphrases of premine account and genesis delegates. Should exist
var private_dir = './benchtest';

// directory to export config and genesisBlock files. Should exist
var output_dir = './benchtest';

// default port for node
var default_port = 6619;
...
// default db named
var db_name = "benchtest_" + network_name;
