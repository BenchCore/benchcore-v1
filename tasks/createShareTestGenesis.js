...
var network_name = "sharetest";
if(!networks[network_name]){
  console.log("WARNING: no configuration found in networks.json for '"+network_name+"'. Defaulting to 'sharetest'");
  network_name = "sharetest";
}

// directory to export passphrases of premine account and genesis delegates. Should exist
var private_dir = './sharetest';

// directory to export config and genesisBlock files. Should exist
var output_dir = './sharetest';

// default port for node
var default_port = 1849;
...
// default db named
var db_name = "sharetest_" + network_name;
...
var totalpremine = 28000000000000000;
...
var config = {
    ...
    fileLogLevel: "info",
    logFileName: "logs/sharetest.log",
