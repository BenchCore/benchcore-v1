...
var network_name = "sharenet";
if(!networks[network_name]){
  console.log("WARNING: no configuration found in networks.json for '"+network_name+"'. Defaulting to 'sharenet'");
  network_name = "sharenet";
}

// directory to export passphrases of premine account and genesis delegates. Should exist
var private_dir = './sharenet';

// directory to export config and genesisBlock files. Should exist
var output_dir = './sharenet';

// default port for node
var default_port = 1850;
...
// default db named
var db_name = "sharenet_" + network_name;
