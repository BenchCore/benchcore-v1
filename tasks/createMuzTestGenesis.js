...
var network_name = "muztest";
if(!networks[network_name]){
  console.log("WARNING: no configuration found in networks.json for '"+network_name+"'. Defaulting to 'muztest'");
  network_name = "muztest";
}

// directory to export passphrases of premine account and genesis delegates. Should exist
var private_dir = './muztest';

// directory to export config and genesisBlock files. Should exist
var output_dir = './muztest';

// default port for node
var default_port = 1876;
...
// default db named
var db_name = "muztest_" + network_name;
