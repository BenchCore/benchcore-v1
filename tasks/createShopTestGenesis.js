...
var network_name = "shoptest";
if(!networks[network_name]){
  console.log("WARNING: no configuration found in networks.json for '"+network_name+"'. Defaulting to 'shoptest'");
  network_name = "shoptest";
}

// directory to export passphrases of premine account and genesis delegates. Should exist
var private_dir = './shoptest';

// directory to export config and genesisBlock files. Should exist
var output_dir = './shoptest';

// default port for node
var default_port = 1795;
...
// default db named
var db_name = "shoptest_" + network_name;
