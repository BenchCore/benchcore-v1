...
var network_name = "shopnet";
if(!networks[network_name]){
  console.log("WARNING: no configuration found in networks.json for '"+network_name+"'. Defaulting to 'shopnet'");
  network_name = "shopnet";
}

// directory to export passphrases of premine account and genesis delegates. Should exist
var private_dir = './shopnet';

// directory to export config and genesisBlock files. Should exist
var output_dir = './shopnet';

// default port for node
var default_port = 1796;
...
// default db named
var db_name = "shopnet_" + network_name;
